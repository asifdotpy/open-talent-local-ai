...
if [ $FAILED -eq 0 ]; then
    ...
    echo -e "   ${BLUE}Swagger UI:${NC}  http://localhost:8015/docs"
    echo -e "   ${BLUE}ReDoc:${NC}       http://localhost:8015/redoc"
    echo -e "   ${BLUE}JSON Schema:${NC} http://localhost:8015/openapi.json"
    echo ""
    exit 0
else
    echo -e "${RED}╔════════════════════════════════════════════════════════════════════════╗${NC}"
