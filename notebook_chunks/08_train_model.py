...
class Config:
    ...
    warmup_steps: int = 10
    output_dir: str = "/content/drive/MyDrive/open-talent-vetta/checkpoints"  # Drive path
    models_dir: str = "/content/drive/MyDrive/open-talent-vetta/models"  # Drive path
...
if "model" not in globals() or "tokenizer" not in globals():
    print("🔄 Model or tokenizer not found in memory. Attempting to load for training...")
    # Load the base model
