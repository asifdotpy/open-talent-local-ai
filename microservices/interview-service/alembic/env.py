...
db_user = os.getenv("POSTGRES_USER", "talent_user")
db_password = os.getenv("POSTGRES_PASSWORD", "talent_password_2025")
db_server = os.getenv("POSTGRES_SERVER", "localhost")
db_port = os.getenv("POSTGRES_PORT", "5432")
db_name = os.getenv("POSTGRES_DB", "talent_ai_interview")
