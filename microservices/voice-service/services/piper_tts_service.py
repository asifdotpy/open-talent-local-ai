...
class PiperTTSService:
    ...
    def __init__(
        ...
        piper_binary: str = "/home/asif1/talent-ai-platform/microservices/voice-service/piper/piper"
    ):
        """
    ...
    def synthesize_speech(
        ...
        try:
            ...
            try:
                ...
                with open(tmp_text_path, 'r') as text_file:
                    result = subprocess.run(
                        cmd,
                        stdin=text_file,
                        capture_output=True,
...
class MockPiperTTSService:
    ...
    def get_available_voices(self) -> List[Dict]:
        """Return mock voices."""
        return [
            {"name": "lessac", "gender": "male", "quality": "medium", "mos": 4.3}
        ]
