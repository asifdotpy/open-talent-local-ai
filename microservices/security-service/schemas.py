...
class UserRegistration(BaseModel):
    ...
    email: EmailStr
    password: str = Field(..., min_length=8, description="Must contain uppercase, lowercase, digits, and special characters")
...
class PermissionCheck(BaseModel):
    ...
    permission: str = Field(..., description="Permission to check (e.g., 'view_interviews', 'take_interview')")
