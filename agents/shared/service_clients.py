"""
HTTP clients for TalentAI microservices.
...
class ConversationServiceClient(BaseServiceClient):
    ...
    async def generate_questions(
        ...
        """
        return await self.post("/conversation/generate-questions", json={
...
class AvatarServiceClient(BaseServiceClient):
    ...
    async def generate_avatar(
        ...
        """
        return await self.post("/generate", json={
...
class InterviewServiceClient(BaseServiceClient):
    ...
    async def create_room(
        ...
        """
        return await self.post("/api/v1/rooms/create", json={
...
class GenkitServiceClient(BaseServiceClient):
    ...
    async def generate_boolean_query(
        ...
        """
        return await self.post("/generateBooleanQuery", json={
    ...
    async def generate_engagement_message(
        ...
        """
        return await self.post("/generateEngagementMessage", json={
    ...
    async def score_candidate_quality(
        ...
        """
        return await self.post("/scoreCandidateQuality", json={
            "name": name,
            "skills": skills,
