        ...
        response = await client.post(
            ...
            json={
                ...
                "participants": [
                    ...
                    {"user_id": "ai-interviewer", "role": "ai_avatar", "display_name": "Vetta AI"},
                ],
                "duration_minutes": 45,
...
async def test_voice_tts(client: httpx.AsyncClient, text: str) -> dict:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return {"duration": duration, "phonemes": phoneme_count, "audio": response.content}
        else:
...
async def test_interview_completion(client: httpx.AsyncClient, room_id: str) -> bool:
    ...
    print("  Assessment: Overall score 85/100")
    print("  Strengths: Technical knowledge, Communication")
    print("  Next steps: HR team will reach out within 2 business days")
    return True
...
async def run_complete_flow():
    ...
    async with httpx.AsyncClient() as client:
        ...
        print("  Integration points validated: 7/7")
