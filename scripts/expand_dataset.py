...
EXPERIENCE_LEVELS = [
    "1-2 years", "3-5 years", "5+ years", "7+ years", "10+ years",
    "entry-level", "mid-level", "senior", "principal", "staff"
]
...
INTERVIEW_TYPES = [
    ...
    "culture fit", "leadership", "problem-solving"
]
...
SKILLS = [
    ...
    "technical writing", "stakeholder management", "prioritization"
]
...
TECHNOLOGIES = [
    ...
    "GraphQL", "REST APIs", "microservices", "CI/CD pipelines",
    "machine learning models", "data pipelines", "distributed systems"
]
...
SENSITIVE_TOPICS = [
    "salary expectations", "work-life balance", "remote work policy",
    "team dynamics", "company stability", "growth opportunities",
    "the previous person in this role", "recent layoffs"
]

TIMEFRAMES = [
    "1-2 business days", "3-5 business days", "one week",
    "7-10 business days", "the next two weeks"
]

PREVIOUS_FIELDS = [
    "finance", "healthcare", "education", "consulting",
    "academia", "startups", "enterprise", "government"
]
...
def generate_behavioral_examples(count: int) -> List[Dict[str, Any]]:
    ...
    situations = ["a team project", "a critical deadline", "organizational change", "a product launch"]
...
def generate_technical_examples(count: int) -> List[Dict[str, Any]]:
    ...
    application_types = ["web applications", "APIs", "data pipelines", "mobile apps", "distributed systems"]
...
def generate_multi_turn_examples(count: int) -> List[Dict[str, Any]]:
    ...
    examples = []
    topics = TECHNOLOGIES + SKILLS + ["your previous role", "a challenging project", "team collaboration"]
    specific_aspects = [
