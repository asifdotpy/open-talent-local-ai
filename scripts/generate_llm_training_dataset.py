#!/usr/bin/env python3
"""
TalentAI Language Model Training Dataset Generator

Generates 2,100+ instruction-response pairs to train the language model
to handle complete TalentAI recruitment pipeline operations.
...
class LLMTrainingDataGenerator:
    """Generate comprehensive LLM training dataset for TalentAI platform"""
    ...
    def generate_scout_coordinator_examples(self) -> List[TrainingExample]:
        ...
        for job_title, skills, exp in job_reqs:
            for urgency, timeline in [("high", "2 weeks"), ("medium", "4 weeks"), ("low", "8 weeks")]:
                for headcount in [1, 3, 5]:
                    examples.append(TrainingExample(
                        ...
                        response=self._generate_sourcing_strategy(job_title, headcount, timeline, urgency),
                        domain="sourcing",
                        agent="scout-coordinator",
                        category="pipeline-initiation",
                        difficulty=self._assess_difficulty(["medium", "high"][urgency == "high"]),
                        context={
                            "scenario": "Recruiter initiating new sourcing pipeline",
                            "constraints": ["Multi-channel approach", "Timeline constraints", f"Need {headcount} candidates"],
        ...
        channels = ["LinkedIn", "GitHub", "StackOverflow", "Recruitment Agency", "Employee Referral", "Job Boards"]
        for _ in range(50):
            ...
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Time constraint: 3 weeks", "Quality threshold: qualified candidates"],
        ...
        for _ in range(70):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Use boolean operators", "Include AND/OR/NOT", "Realistic search"],
        ...
        for _ in range(70):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["GitHub search syntax", "Activity signals", "Contribution quality"],
        ...
        for _ in range(70):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Reputation signals", "Answer quality", "Expertise verification"],
        ...
        for _ in range(80):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Character limit awareness", "Professional tone", "Personalized"],
        ...
        for _ in range(60):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Casual but professional", "Progressive value", "CTA in final message"],
        ...
        for _ in range(60):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Observable signals", "Role-specific", "Quality indicators"],
        ...
        for _ in range(50):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Code quality signals", "Contribution frequency", "Skill relevance"],
        ...
        for _ in range(30):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Match confidence threshold", "Consider variations", "False positive cost"],
        ...
        for _ in range(20):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Parse accurately", "Handle missing data", "Standardized format"],
        ...
        for _ in range(80):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Specific scoring", "Gap identification", "Trainability assessment"],
        ...
        for _ in range(70):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Years != competence", "Relevant experience", "Growth potential"],
        ...
        for _ in range(50):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Predictive signals", "Team compatibility", "Growth mindset"],
        ...
        for _ in range(50):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Realistic comparison", "Compensation", "Benefits", "Growth"],
        ...
        for _ in range(50):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Real-time sync", "Data consistency", "History preservation"],
        ...
        for _ in range(100):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Role-specific", "Background-aware", "Behavioral + Technical"],
        ...
        for _ in range(80):
            examples.append(TrainingExample(
                ...
                context={
                    ...
                    "constraints": ["Candidate progression", "Time efficiency", "Decision quality"],
    ...
    def _generate_sourcing_strategy(self, job_title: str, headcount: int, timeline: str, urgency: str) -> str:
    ...
    def _generate_github_query(self) -> str:
        ...
        return 'language:go stars:>100 topic:kubernetes topic:cloud-native created:>2022 followers:>50'
    ...
    def _generate_interview_scenario(self) -> str:
        ...
        background = random.choice(["5 years at Google", "3 years at startup", "4 years at Facebook"])
    ...
    def generate_report(self) -> Dict:
        ...
        # Calculate averages
        avg_quality = sum(ex.metadata.get("quality_score", 0) for ex in self.examples) / len(self.examples)
