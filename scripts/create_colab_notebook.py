...
notebook = {
    "cells": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": [
            "# 🚀 Granite 3.0 2B - Comprehensive TalentAI Fine-Tuning (v4)\n\n",
            "**Dataset:** 2,075 examples (1,660 train / 415 val) | **Domains:** 8 | **Quality:** 0.875 avg\n\n",
            "**Goal:** Fine-tune Granite 3.0 2B on complete TalentAI platform capabilities\n\n",
        ...
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
            ...
            "    'huggingface': {'username': 'asifdotpy', 'version': 'v4', 'lora_repo': 'asifdotpy/vetta-granite-2b-lora-v4', 'dataset_repo': 'asifdotpy/talentai-comprehensive-dataset'}\n",
            "}\n\n",
            "# Create directories\n",
        ...
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
            ...
            "    !wget -q https://raw.githubusercontent.com/asifdotpy/talent-ai-platform/main/notebooks/data/llm_training_train.json -O {train_file}\n",
            "    !wget -q https://raw.githubusercontent.com/asifdotpy/talent-ai-platform/main/notebooks/data/llm_training_validation.json -O {val_file}\n",
        ...
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
            ...
            "                 commit_message='Upload comprehensive TalentAI platform LoRA v4')\n",
        ...
        {"cell_type": "markdown", "metadata": {}, "source": [
            ...
            "**Dataset:** https://huggingface.co/datasets/asifdotpy/talentai-comprehensive-dataset"
        ]}
    ],
    "metadata": {
...
# Save notebook
output_path = "/home/asif1/talent-ai-platform/notebooks/granite_fine_tuning_v4_comprehensive.ipynb"
