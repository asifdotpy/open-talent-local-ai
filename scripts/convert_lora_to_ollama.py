...
SYSTEM You are a {persona} interviewer for TalentAI platform. You conduct professional interviews with expertise in {persona} topics. Be concise, clear, and focused on assessing candidate skills.
...
def main():
    ...
    parser.add_argument("--lora", default="asifdotpy/vetta-granite-2b-lora-v3", help="LoRA repository")
    ...
    parser.add_argument("--skip-convert", action="store_true", help="Skip conversion, just create Modelfiles")
    ...
    print("   ollama create technical_interviewer -f ollama_modelfiles/technical_interviewer.Modelfile")
    print("   ollama create behavioral_interviewer -f ollama_modelfiles/behavioral_interviewer.Modelfile")
