...
def validate_dataset(filepath: str = "notebooks/data/llm_training_dataset.json") -> Dict:
    ...
    required_fields = ["instruction", "input", "response", "domain", "agent", "category", "difficulty", "context", "metadata"]
    field_count = {field: 0 for field in required_fields}
