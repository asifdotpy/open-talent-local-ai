"""
TalentAI Granite Interview Service - Main Application
...
# Create FastAPI app
app = FastAPI(
    title="TalentAI Granite Interview Service",
...
async def root():
    ...
    return {
        "service": "TalentAI Granite Interview Service",
        "version": "1.0.0",
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="0.0.0.0", port=port)</content>
<parameter name="filePath">/home/asif1/talent-ai-platform/microservices/granite-interview-service/app/main.py