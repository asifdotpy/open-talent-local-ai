...
class TestCandidateServiceIntegration:
    ...
    def test_health_endpoint(self):
        ...
        # Service should always return 200, even if database/vector search unavailable
    ...
    def test_root_endpoint(self):
        ...
        assert "TalentAI Candidate Service" in data["service"]
    ...
    def test_create_candidate_profile_valid(self):
        ...
        response = self.client.post("/api/v1/candidates", json=candidate_data)

        # Should succeed (200) or fail with 500 if vector search not available
    ...
    def test_create_candidate_profile_minimal(self):
        ...
        response = self.client.post("/api/v1/candidates", json=minimal_data)
    ...
    def test_create_candidate_profile_invalid_data(self):
        ...
        response = self.client.post("/api/v1/candidates", json=invalid_data)
    ...
    def test_create_candidate_profile_missing_fields(self):
        ...
        response = self.client.post("/api/v1/candidates", json=incomplete_data)
    ...
    def test_get_candidate_profile_existing(self):
        ...
        create_response = self.client.post("/api/v1/candidates", json=candidate_data)
        if create_response.status_code == 200:
            candidate_id = create_response.json()["candidate_id"]

            # Now retrieve the profile
            response = self.client.get(f"/api/v1/candidates/{candidate_id}")
            ...
            response = self.client.get("/api/v1/candidates/mock-id")
            assert response.status_code == 200
            data = response.json()
    ...
    def test_get_candidate_profile_not_found(self):
        ...
        response = self.client.get("/api/v1/candidates/nonexistent-id")
    ...
    def test_get_candidate_profile_invalid_id(self):
        ...
        response = self.client.get("/api/v1/candidates/invalid@id")
    ...
    def test_unsupported_http_method(self):
        ...
        response = self.client.put("/api/v1/candidates")
    ...
    def test_performance_candidate_creation(self):
        ...
        # Response should be successful (may be 200 or 500)
        assert response.status_code in [200, 500]
