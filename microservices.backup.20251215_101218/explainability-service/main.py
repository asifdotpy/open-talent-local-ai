...
app = FastAPI(
    title="TalentAI Explainability Service API",
    description="""
    AI explainability and transparency service for the TalentAI platform.
...
async def root():
    ...
    return {"message": "TalentAI Explainability Service is running!"}
...
async def api_docs_info():
    ...
    return {
        "service": "TalentAI Explainability Service API",
        "version": "1.0.0",
