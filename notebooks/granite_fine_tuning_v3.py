...
print(f"✅ Dataset: {len(dataset)} examples ({len(VETTA_EXAMPLES)} unique × {config.data_repetitions} reps)")
print(f"\n📝 Sample:\n{dataset[0]['text'][:400]}...")
print(f"\n📊 Dataset composition:")
categories = {}
for ex in train_examples:
...
**🎉 Congratulations! Vetta is ready to conduct professional AI interviews.**
