...
for various OpenTalent platform tasks.
"""
...
class VettaOrchestrator:
    """Multi-persona Vetta AI orchestrator for OpenTalent platform."""
    ...
    def _load_persona_prompts(self):
        ...
        try:
            with open("data/vetta_persona_prompts.json") as f:
                return json.load(f)
...
def main():
    ...
    try:
        ...
        print(
            "To run with actual model, ensure the fine-tuned model is available at ./vetta_granite_fine_tuned"
        )
